#script to pull all genes with a combined exomiser score over a defined cutoff and provide a count of how many times variants in each gene were seen in the patient cohort
...
#group and count repeated genes - order descending
